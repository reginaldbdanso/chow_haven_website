      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div>
            ...
            <p className="text-sm">We are a team of passionate food lovers and culinary enthusiasts, dedicated to bringing you unforgettable flavors and the finest dining experiences.</p>
          </div>
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Quick Links</h3>
            <ul className="text-sm space-y-2">
              <li><Link to="/" className="hover:text-gray-900">Home</Link></li>
              <li><Link to="/menu" className="hover:text-gray-900">Menu</Link></li>
          ...
          <div>
            ...
            <ul className="text-sm space-y-2">
              <li><a href="#" className="hover:text-gray-900">Continental Dishes</a></li>
              <li><a href="#" className="hover:text-gray-900">Local Dishes</a></li>
        ...
        <div className="border-t border-gray-200 mt-12 pt-8 text-sm text-center">
          © 2024 Chop Haven. All rights reserved.
        </div>
      </div>
    </footer>
  );
